...
// Image-library catalog + doctor shapes live in their own module to keep
// this file within the max-lines budget; re-exported so every caller can
// keep importing them from "../types".
